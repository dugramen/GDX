...
## Installation
Drag and drop the 'addons/gdx' folder into your own 'addons' folder

## Usage
Create a .gdscript file that extends 'GDX'. 
Below is an example of a to-do list application, commented with explanations
...
# 2nd argument is for decalring state that will be remembered accross UI updates
...
func render():
	...
	return [
		...
		{ 
			...
			# Override theme properties with 'override_constant', 'override_font', 'override_stylebox' etc
			override_constant = {
...
![gdx-checklist](https://user-images.githubusercontent.com/54819319/209497757-eac7356a-fe59-43b4-bbbb-bea6a614a8a0.png)
